...
public class DummyGame implements IGameLogic {
    ...
    public void init(Window window) throws Exception {
        ...
        Mesh[] rocketMesh = StaticMeshesLoader.load("models/rocket/rocket.obj", "models/rocket");
        GameItem rocket = new GameItem(rocketMesh);
        rocket.setScale(0.01f);

        scene.setGameItems(new GameItem[]{rocket});
        ...
        camera.getRotation().x = 95.0f;
        camera.getRotation().y = 180.f;
    }
